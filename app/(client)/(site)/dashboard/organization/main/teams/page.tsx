...
const page = () => {
  ...
  const teams = JSON.parse(searchParams.get("teams")!);
    ...
    <Layout>
      ...
      <div className="w-full h-full grid grid-cols-4 gap-x-6">
        <div className="w-full h-max flex flex-col col-span-3">
          <div className=" font-bold text-xl mb-2 text-gray-700 my-4">Currently {organizationName} Have These Active Teams!</div>
