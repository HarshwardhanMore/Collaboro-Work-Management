    ...
    <NavigationMenu>
      <NavigationMenuList>
          ...
          <NavigationMenuContent className=" bg-white">
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="" title="Create Project">
                Start a New Project Under {data?.name}.
              </ListItem>
              <ListItem href="" title="Make Team">
                Make a New Team For {data?.name}.
              </ListItem>
              <ListItem href="" title="Add Employee">
                Add New Employee In {data?.name}.
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
          ...
          <NavigationMenuContent className=" bg-white">
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="" title="Teams">
                Explore All The Teams Under {data?.name}.
              </ListItem>
              <Link href={{
                pathname: "/dashboard/organization/main/employees",
                query: {
                  employees: JSON.stringify(data?.OrganizationPerson)
                }
              }}>
                <ListItem href="" title="Employees">
                  Explore All The Employees Under {data?.name}.
                </ListItem>
              </Link>
          ...
          <NavigationMenuContent className=" bg-white">
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href="" title="Projects">
                Explore All The Projects Under {data?.name}.
              </ListItem>
              <ListItem href="" title="Sprints">
                Explore All The Sprints Under {data?.name}.
              </ListItem>
              <ListItem href="" title="Tasks">
                Explore All The Tasks Under {data?.name}.
              </ListItem>
            </ul>
          </NavigationMenuContent>
        </NavigationMenuItem>
        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent className=" bg-white">
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <ListItem href="" title={`${data?.name}`}>
                Explore Performance of {data?.name}.
              </ListItem>
              <ListItem href="" title="Projects">
